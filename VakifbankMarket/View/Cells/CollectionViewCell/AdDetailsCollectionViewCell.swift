//
//  AdDetailsCollectionViewCell.swift
//  VakifbankMarket
//
...
class AdDetailsCollectionViewCell: UICollectionViewCell {
    ...
    lazy var brandLabel = CustomLabels(text: "", font: .systemFont(ofSize: 16, weight: .bold), color: .black)
    lazy var productNameLabel = CustomLabels(text: "", font: .systemFont(ofSize: 16), color: .darkGray)
    lazy var priceLabel = CustomLabels(text: "", font: .systemFont(ofSize: 18, weight: .semibold), color: .systemYellow)
