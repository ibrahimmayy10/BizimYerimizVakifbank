//
//  HomePagePopularProductsCollectionView.swift
//  VakifbankMarket
//
//  Created by İbrahim Ay on 26.07.2024.
//

import UIKit

class HomePagePopularProductsCollectionViewCell: UICollectionViewCell {
    ...
    lazy var favoriteLabel = CustomLabels(text: "", font: .systemFont(ofSize: 14), color: .black)
